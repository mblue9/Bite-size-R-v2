...
Optional section. Do this if you've completed the previous sections and the Assignment below and want more. In this section we're going to look a **line plot**. These are created using similar ggplot grammar to what we've already seen. Line plots are
...
* Plotting time series data as line graphs and working with dates
