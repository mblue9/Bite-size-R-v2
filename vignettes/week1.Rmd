...
* R integrates with other tools to generate manuscripts from your code. This document ([R Markdown](https://rmarkdown.rstudio.com/), a .Rmd file) is a case in point. We will be using R Markdown in this course. Information on creating R Markdown manuscripts for journals can be found [here](https://bookdown.org/yihui/rmarkdown/journals.html#ref-R-rticles) and in [this paper](https://www.sciencedirect.com/science/article/pii/S2667145X21000171). Some examples of R Markdown in action:
