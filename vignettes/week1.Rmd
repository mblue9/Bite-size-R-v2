...
When importing the METABRIC dataset we specified the file using a URL `https://zenodo.org/record/6426303/files/brca_metabric_clinical_data.tsv`
...
metabric_downloaded <- read_tsv("~/Downloads/")
```
