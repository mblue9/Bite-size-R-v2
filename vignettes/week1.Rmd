...
As this is a 'next-steps' course, designed for follow-on practice with cancer datasets after completing DataCamp's Introduction to the Tidyverse (or another general introductory R course), we assume you know some R basics already. [R for Data Science book](https://r4ds.had.co.nz/index.html) is an excellent reference book if you want to look up anything you don't recall or are not very familiar with. We also assume you know some reasons why learning R is good, as you've already started, but below are a list of reasons why learning R is useful and worth your time. 
...
This document (R Markdown a .Rmd file) is a case in point. Information on creating R Markdown manuscripts for journals can be found [here](https://bookdown.org/yihui/rmarkdown/journals.html#ref-R-rticles) and in [this paper](https://www.sciencedirect.com/science/article/pii/S2667145X21000171). 
 ...
 * In your RStudio top menu go to File > Open File and open the file 
 * Click the Knit button at the top of the Editing pane to generate the report
 * Try out the exercise in the Rmd file to edit the file. Knit again to see the changes.
