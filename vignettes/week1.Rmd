...
```{r, echo=FALSE, out.width = "100px"}
knitr::include_graphics("../inst/images/Rstudio_scripting.png")
```
...
```{r, echo=FALSE, out.width = "100px"}
knitr::include_graphics("../inst/images/Rstudio_console.png")
```
...
```{r, echo=FALSE, out.width = "100px"}
knitr::include_graphics("../inst/images/Rstudio_filexpl.png")
```
