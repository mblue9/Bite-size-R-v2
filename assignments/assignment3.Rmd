...
Compute the body mass index (BMI) of characters in the `starwars` tibble. The starwars dataset is part of the dplyr package and is available when you use `library(tidyverse)` or `library(dplyr)`.
